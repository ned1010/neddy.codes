...
function MobileNav() {
	...
	return (
		...
		>
			...
			<NavLink className="nav-link" target="_blank" to={"https://drive.google.com/file/d/1uy59P4Shhy2h90cqPB-J2JdyNPZtDpIX/view"} onClick={toggleVisible} style={iconStyle}>
				<Box>
